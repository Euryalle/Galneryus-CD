    ...
    public class HitObjectHighlight2 : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            foreach (var hitobject in Beatmap.HitObjects)
            {
                ...
                hSprite.Scale(0, hitobject.StartTime, hitobject.EndTime + FadeDuration, SpriteScale, SpriteScale * 2);
                hSprite.Fade(0, hitobject.StartTime, hitobject.EndTime + FadeDuration, 1, 0);
