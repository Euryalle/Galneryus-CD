...
namespace StorybrewScripts
{
    public class LyricsKala : StoryboardObjectGenerator
    {
        ...
        [Configurable]
        public string FontName = "Hina Mincho";
        ...
        public override void Generate()
        {
            ...
            // Verse 1
            CreateLyrics(font, "Destiny", FontName, FontSize, new Vector2(320, 410), 41387, 42870);
            CreateLyrics(font, "Is calling you", FontName, FontSize, new Vector2(320, 410), 43035, 44834);
            CreateLyrics(font, "Passing through your edge of heart", FontName, FontSize, new Vector2(320, 410), 44996, 47267);
            CreateLyrics(font, "We're not a loss anymore, and look up your future", FontName, FontSize, new Vector2(320, 410), 47429, 54283); 
            CreateLyrics(font, "もう迷うことなど無い", FontName, FontSize, new Vector2(320, 410), 73036, 75822);
            CreateLyrics(font, "悩み続けることも無い", FontName, FontSize, new Vector2(320, 410), 78099, 81030);
            CreateLyrics(font, "見上げたその時、全てに気づいた", FontName, FontSize, new Vector2(320, 410), 83474, 88537);
            CreateLyrics(font, "今までの過ちを", FontName, FontSize, new Vector2(320, 410), 88699, 92933);
            CreateLyrics(font, "自分を見失いそうになることなんて、もう無いはず", FontName, FontSize, new Vector2(320, 410), 93843, 104996);
            CreateLyrics(font, "ただ一つの同じ星を見てる", FontName, FontSize, new Vector2(320, 410), 105324, 113458);
            // Chorus 1
            CreateLyrics(font, "Destiny", FontName, FontSize, new Vector2(320, 410), 117043, 118510);
            CreateLyrics(font, "Is calling you", FontName, FontSize, new Vector2(320, 410), 118673, 120628);
            CreateLyrics(font, "Passing through your edge of heart", FontName, FontSize, new Vector2(320, 410), 120629, 122912);
            CreateLyrics(font, "We're not a loss anymore, and look up your future", FontName, FontSize, new Vector2(320, 410), 123075, 126677);
            CreateLyrics(font, "And surely, we'll unite once again", FontName, FontSize, new Vector2(320, 410), 126841, 130920);
            CreateLyrics(font, "We're filled with power, don't lose the past", FontName, FontSize, new Vector2(320, 410), 131083, 134505);
            CreateLyrics(font, "Gone with the steel", FontName, FontSize, new Vector2(320, 410), 134668, 137775);
            // Verse 2
            CreateLyrics(font, "もう逃げることなど無い", FontName, FontSize, new Vector2(320, 410), 148688, 151468);
            CreateLyrics(font, "抱え続けるものも無い", FontName, FontSize, new Vector2(320, 410), 153913, 156685);
            CreateLyrics(font, "見上げたその時、全てに気づいた", FontName, FontSize, new Vector2(320, 410), 159131, 164185);
            CreateLyrics(font, "今までの過ちを", FontName, FontSize, new Vector2(320, 410), 164348, 168750);
            CreateLyrics(font, "自分を見失いそうになることなんて、もう無いはず", FontName, FontSize, new Vector2(320, 410), 169565, 180639);
            CreateLyrics(font, "ただ一つの同じ星を見てる", FontName, FontSize, new Vector2(320, 410), 180966, 189125);
            // Chorus 2
            CreateLyrics(font, "Destiny", FontName, FontSize, new Vector2(320, 410), 192697, 194163);
            CreateLyrics(font, "Is calling you", FontName, FontSize, new Vector2(320, 410), 194326, 196281);
            CreateLyrics(font, "Passing through your edge of heart", FontName, FontSize, new Vector2(320, 410), 196282, 198565);
            CreateLyrics(font, "We're not a loss anymore, and look up your future", FontName, FontSize, new Vector2(320, 410), 198728, 202330);
            CreateLyrics(font, "And surely, we'll unite once again", FontName, FontSize, new Vector2(320, 410), 202494, 206573);
            CreateLyrics(font, "We're filled with power, don't lose the past", FontName, FontSize, new Vector2(320, 410), 206736, 210158);
            CreateLyrics(font, "Gone with the steel", FontName, FontSize, new Vector2(320, 410), 210321, 213428);
            // bridge
            CreateLyrics(font, "今にも消えそうだった光よ、もう一度導け", FontName, FontSize, new Vector2(320, 410), 319569, 330651); 
            CreateLyrics(font, "ただ一つの同じ星を見てる", FontName, FontSize, new Vector2(320, 410), 330982, 342536);
            // Chorus 3
            CreateLyrics(font, "Destiny", FontName, FontSize, new Vector2(320, 410), 345305, 346772);
            CreateLyrics(font, "Is calling you", FontName, FontSize, new Vector2(320, 410), 346935, 348890);
            CreateLyrics(font, "Passing through your edge of heart", FontName, FontSize, new Vector2(320, 410), 348891, 351174);
            CreateLyrics(font, "We're not a loss anymore, and look up your future", FontName, FontSize, new Vector2(320, 410), 351337, 354939);
            CreateLyrics(font, "And surely, we'll unite once again", FontName, FontSize, new Vector2(320, 410), 355103, 359182);
            CreateLyrics(font, "We're filled with power, don't lose the past", FontName, FontSize, new Vector2(320, 410), 359345, 362767);
            CreateLyrics(font, "Gone with the steel", FontName, FontSize, new Vector2(320, 410), 362930, 366037);
            // Last part 
            CreateLyrics(font, "Destiny is calling you, but you don't believe it", FontName, FontSize, new Vector2(320, 410), 366184, 371069);
            CreateLyrics(font, "Keeper of the resurrection is standing alone", FontName, FontSize, new Vector2(320, 410), 371394, 375656);
            CreateLyrics(font, "And surely, we'll unite once again with strong faith", FontName, FontSize, new Vector2(320, 410), 375984, 381345);
            CreateLyrics(font, "Live to survive, live for my life", FontName, FontSize, new Vector2(320, 410), 381508, 386236);
            CreateLyrics(font, "Just like those stars", FontName, FontSize, new Vector2(320, 410), 386399, 397837);
        }
        ...
        private void CreateLyrics(FontGenerator font, string Sentence, string FontName, int FontSize, Vector2 position, int StartTime, int EndTime)
        {
            ...
            //var fadeCount = Beat/16;
            foreach (var letter in Sentence) // lyrics creation
            {
                var texture = font.GetTexture(letter.ToString());
                if (!texture.IsEmpty)
                {
